...
catfile = 'events_TA_2012_6.3.xml'
...
if not os.path.exists(catfile):
    catalog = client.get_events(starttime=starttime, endtime=endtime,minmagnitude=6,maxmagnitude=9.9,\
...
inventory_big = client.get_stations(network="TA",station='*',maxlatitude=50,startafter=time_start_a,startbefore=time_start_b,
endbefore=time_end_b,endafter=time_end_a, minlongitude=-95,maxlongitude=-84)
...
c_one.append(catalog[7])
# c_one.append(catalog[23])
print(c_one.__str__(print_all=True))
